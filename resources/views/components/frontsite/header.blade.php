...
<nav x-data="{ navbarMobileOpen: false }" class="bg-white">
    <div class="max-w-7xl mx-auto px-4 lg:px-14 pt-6 lg:py-10">
        <div class="flex justify-between h-16">
            <div class="flex flex-auto justify-between">
                ...
                <div class="hidden lg:ml-6 lg:flex lg:space-x-12">
                    ...
                    <a href="{{ route('index') }}"
                        class="text-[#1E2B4F] relative {{ request()->is('/') ? "after:absolute after:content-[''] after:border-b-2 after:border-[#0EFB71] after:w-8/12 after:-translate-x-1/2 after:bottom-3 after:left-1/2 font-semibold inline-flex items-center px-1 text-lg" : 'hover:text-gray-500 inline-flex items-center px-1 pt-1 text-lg font-medium' }} ">
                        Beranda
                    </a>
                ...
                @guest
                    ...
                    <div class="hidden lg:ml-10 lg:flex lg:items-center">
                        <a href="{{ route('login') }}"
                            class="inline-flex items-center rounded-full text-white text-lg font-medium bg-[#0EFB71] px-10 py-3">
                            Masuk
                        </a>
                    </div>
                    ...
                    <div class="-mr-2 flex items-center lg:hidden">
                        <button type="button"
                            class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#0EFB71]"
                            ...
                            <div>
                                <button type="button" class="bg-white rounded-full flex text-sm focus:outline-none"
                                    ...
                                    <div class="text-right mr-5">
                                        ...
                                        <div class="text-sm text-[#AFAEC3]">Menu

                                        </div>
                                    </div>
                                    <img class="h-12 w-12 rounded-full ring-1 ring-offset-4 ring-[#0EFB71]"
        ...
        <div class="lg:hidden" id="mobile-menu" x-show="navbarMobileOpen">
            ...
            -->
                <a href="#"
                    class="bg-indigo-50 border-[#0EFB71] text-[#1E2B4F] block pl-3 pr-4 py-2 border-l-4 text-base font-semibold">Beranda</a>
                <a href="#"
                    class="border-transparent text-[#1E2B4F] hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium">Jadwal
                    Dokter</a>
                {{--  <a
            href="#"
...
@endguest
            ...
            @auth
            <div class="py-3 border-gray-200">
                <a class="text-[#1E2B4F] text-base font-medium mb-2">Hi, {{ Auth::user()->name }}</a>
                <a href="{{ route('backsite.dashboard.index') }}"
                                    class="border-transparent text-[#1E2B4F] hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium" role="menuitem"
                                    tabindex="-1" id="user-menu-item-1">Dashboard</a>
                <a href="{{ route('logout') }}"
                    class="border-transparent text-[#1E2B4F] hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
                    Sign Out
