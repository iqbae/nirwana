...
<nav x-data="{ navbarMobileOpen: false }" class="bg-white">
                    ...
                    <div x-data="{ profileDekstopOpen: false }" class="ml-3 relative">
                        <div>
                            ...
                            >
                                ...
                                <img
                                class="h-12 w-12 rounded-full ring-1 ring-offset-4 ring-[#0EFB71]"
    ...
    <div class="lg:hidden" id="mobile-menu" x-show="navbarMobileOpen">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <a
            href="#"
            class="bg-indigo-50 border-[#0EFB71] text-[#1E2B4F] block pl-3 pr-4 py-2 border-l-4 text-base font-semibold"
            >Beranda</a
            >
            <a
            href="#"
