                                            ...
                                            @csrf
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group row {{ $errors->has('specialist_id') ? 'has-error' : '' }}">
                                                        <label class="col-md-3 label-control">Specialist <code style="color:red;">diperlukan</code></label>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control" for="fee">Fee <code style="color:red;">diperlukan</code></label>
                                                        <div class="col-md-9 mx-auto">
