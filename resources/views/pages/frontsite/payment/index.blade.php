    ...
    <div class="min-h-screen">
        <div class="max-w-7xl grid lg:grid-cols-12 mx-auto pt-14 lg:pt-20 pb-20 lg:pb-28 lg:divide-x px-4 lg:px-16">
            ...
            <div class="lg:col-span-5 lg:pl-20 lg:pr-7 mt-10 lg:mt-0">
                <h3 class="text-[#1E2B4F] text-3xl font-semibold leading-normal">Pilih Metode <br />Pembayaran Anda
                </h3>
                ...
                <form action="{{ route('payment.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="mt-10 grid">
                        ...
                        <a href="{{ route('index') }}" type="button" class="bg-[#0D63F3] text-white px-10 py-3 rounded-full text-center"
                            onclick="return confirm('Pastikan melakukan pembayaran kekasir setibanya dirumah sakit')">Bayar dikasir</a>
                    </div>
                </form>
            </div>
